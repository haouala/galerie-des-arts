...
use Esprit\GalerieBundle\Entity\Element;
use Esprit\GalerieBundle\Form\ElementType;
...
class ElementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EspritGalerieBundle:Element')->findAll();

        return $this->render('EspritGalerieBundle:Element:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EspritGalerieBundle:Element:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EspritGalerieBundle:Element')->find($id);
        ...
        return $this->render('EspritGalerieBundle:Element:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EspritGalerieBundle:Element:edit.html.twig', array(
            'entity'      => $entity,
