...
use Esprit\GalerieBundle\Entity\Message;
use Esprit\GalerieBundle\Form\MessageType;
...
class MessageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EspritGalerieBundle:Message')->findAll();

        return $this->render('EspritGalerieBundle:Message:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EspritGalerieBundle:Message:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EspritGalerieBundle:Message')->find($id);
        ...
        return $this->render('EspritGalerieBundle:Message:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EspritGalerieBundle:Message:edit.html.twig', array(
            'entity'      => $entity,
