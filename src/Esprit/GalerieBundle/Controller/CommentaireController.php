...
use Esprit\GalerieBundle\Entity\Commentaire;
use Esprit\GalerieBundle\Form\CommentaireType;
...
class CommentaireController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EspritGalerieBundle:Commentaire')->findAll();

        return $this->render('EspritGalerieBundle:Commentaire:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('EspritGalerieBundle:Commentaire:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EspritGalerieBundle:Commentaire')->find($id);
        ...
        return $this->render('EspritGalerieBundle:Commentaire:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('EspritGalerieBundle:Commentaire:edit.html.twig', array(
            'entity'      => $entity,
